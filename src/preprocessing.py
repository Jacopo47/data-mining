...
# 20. Add WEEKEND from CRASH_DAY_OF_WEEK
print('20. Add WEEKEND from CRASH_DAY_OF_WEEK')
...
# End preprocessing
df.to_csv('Traffic_Crashes-afterGenericPreprocessing.csv', index=False, quotechar='"')
